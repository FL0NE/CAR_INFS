 ...
 *  You can configure a Array of {@link MyOBDCommand}, which will be executed as often and as fast as configured.
 * Created by abr
 */
...
public class PeriodicOBDConnector extends Thread {
     ...
     * @param periods the number of requests per {@link MyOBDCommand} (null for infinity)
     * @param commands the Array of {@link MyOBDCommand}s that will be executed in each periode.
     */
    public PeriodicOBDConnector(BluetoothDevice device, long sleep, Integer periods, MyOBDCommand... commands) {
        this.device = device;
     ...
     * @param commands the Array of {@link MyOBDCommand}s that will be executed in each periode.
     */
    public PeriodicOBDConnector(BluetoothDevice device, long sleep, MyOBDCommand... commands) {
        this.device = device;
        this.sleep=sleep;
        this.commands = commands;
    }
     ...
     * Will create a {@link OBDConnector} in each loop and executes it with the {@link MyOBDCommand}s, given in the constructor.
